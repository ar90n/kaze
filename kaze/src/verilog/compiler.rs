            ...
            if let Some(expr) = match frame {
                Frame::Enter(signal) => {
                    ...
                    match signal.data {
                        ...
                        internal_signal::SignalData::Input { data } => Some(Expr::Ref {
                            name: data.name.clone(),
                        }),

                        internal_signal::SignalData::Reg { data } => Some(Expr::Ref {
                            name: data.name.clone(),
                        }),
                        ...
                        internal_signal::SignalData::Output { data } => Some(Expr::Ref {
                            name: data.name.clone(),
                        }),
